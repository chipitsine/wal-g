...
import (
	...
	/*
	 * We previously used github.com/jackc/pgx/v4/stdlib as our Postgres driver,
	 * but it had a vulnerability (GO-2026-4518) with no fix available in v2.
	 * We now use pgx/v5/stdlib which is also registered under the "pgx" driver name.
	 */
